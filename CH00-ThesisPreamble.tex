...
%\usepackage[parfill]{parskip} % helps with spacing
...
%newer bibliography package. setup follows.
\usepackage{csquotes} % better smart quotes.  Especially usefull for humanities
\usepackage[style=authoryear-comp, url=true, backend=biber]{biblatex} % This has a TON of options.
