...
\usepackage{lipsum}
   % Verbatim input.  Allow for direct input of .txt files into .tex
...
\usepackage[maxcitenames=2, style=authoryear-icomp, bibencoding=utf8, url=true, backend=biber]{biblatex} %bibencoding=utf8
...
\def\subfiguremid{
	\renewcommand{\thefigure}{\thechapter.\arabic{figure} (Cont)}
	\addtocounter{figure}{-1}
	\captionsetup[figure]{list=no}
}
\def\tablevspace{
	\setlength{\bigskipamount}{36pt plus 2pt minus 2pt}
	\bigskip
	\setlength{\bigskipamount}{12pt plus 2pt minus 2pt}
}
\def\tableCustomSize{0.9\textwidth}
