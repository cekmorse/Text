...
\clearpage
\subsection{River Storage Change Results}
%The depths and top widths were visually compared to confirm that the calculation results were reasonable.  Figures \ref{fig:TWandH_USR} and \ref{fig:TWandH_DSR} show the flow depths and river top widths for river segments in the USR and DSR, respectively.  The flow depths and widths presented are the stochastic model mean time-series values.  The primary purpose of this analysis was to determine if the computational code and assumptions used to generate the stochastic distributions of river segment average daily flow depth and average daily top width were performed correctly.

% Example figure option
%\begin{figure}[htbp]
%\centering
%	\includegraphics[width=6in]{"Figures/Results_USR/Stochastic/G d&w Today A"}
%	\caption[River segment flow depth and top width results comparison.]{River segment flow depth and top width results comparison.  This is an example figure presenting the results for river segment A in the USR.  Additional figures for the other USR and DSR river segments are provided in the appendix.}
%	\label{fig:ExampleTWandH}
%\end{figure}

% These results are presented in other figures
%\begin{figure}[htbp]
%	\centering
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.75\linewidth]{"Figures/Results_USR/Stochastic/G d&w Today A"}
%		\subcaption{Segment A}
%		\label{sub:TWandH_A}
%	\end{subfigure}%
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.75\linewidth]{"Figures/Results_USR/Stochastic/G d&w Today B"}
%		\subcaption{Segment B}
%		\label{sub:TWandH_B}
%	\end{subfigure}
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.75\linewidth]{"Figures/Results_USR/Stochastic/G d&w Today C"}
%		\subcaption{Segment C}
%		\label{sub:TWandH_C}
%	\end{subfigure}%
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.75\linewidth]{"Figures/Results_USR/Stochastic/G d&w Today D"}
%		\subcaption{Segment D}
%		\label{sub:TWandH_D}
%	\end{subfigure}
%	\begin{subfigure}{0.5\textwidth}
%		\centering
%		\includegraphics[width=0.75\linewidth]{"Figures/Results_USR/Stochastic/G d&w Today E"}
%		\subcaption{Segment E}
%		\label{sub:TWandH_E}
%	\end{subfigure}
%	\caption[River segment flow depth and top width results comparison.]{River segment flow depth and top width results comparison.}
%	\label{fig:TWandH_USR}
%\end{figure}
%
%\begin{figure}[htbp]
%	\centering
%	\missingfigure{figs not done in R}
%%	\begin{subfigure}{0.5\textwidth}
%%		\centering
%%		\includegraphics[width=0.75\linewidth]{"Figures/Results_DSR/Stochastic/G d&w Today F"}
%%		\subcaption{Segment F}
%%		\label{sub:TWandH_F}
%%	\end{subfigure}%
%%	\begin{subfigure}{0.5\textwidth}
%%		\centering
%%		\includegraphics[width=0.75\linewidth]{"Figures/Results_DSR/Stochastic/G d&w Today G"}
%%		\subcaption{Segment G}
%%		\label{sub:TWandH_G}
%%	\end{subfigure}
%	\caption[River segment flow depth and top width results comparison.]{River segment flow depth and top width results comparison.}
%	\label{fig:TWandH_DSR}
%\end{figure}

%Goodness-of-fit is not an analysis performed on the analysis presented in Figures \ref{fig:TWandH_USR} and \ref{fig:TWandH_DSR}.  Analysis is restricted to verifying that the stochastic mean time-series flow depth and calculated top width are within acceptable ranges.  Flow depth values should be between \SIrange{0.15}{1.5}{\meter} (\SIrange{0.5}{5}{\foot}).  Top width values should be within the ranges surveyed.  All figures show that this is true.
...
%\begin{figure}[htbp]
%\centering
%	\includegraphics[width=6in]{"Figures/Results_USR/Stochastic/G TS A"}
...
\begin{landscape}
	\begin{figure}
		\begin{subfigure}{0.9\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{"Figures/Results_USR/Stochastic/G TS A"}
			\subcaption{Segment A}		
			\label{sub:GeoTS_A}
		\end{subfigure}%
		\begin{subfigure}{0.9\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{"Figures/Results_USR/Stochastic/G TS B"}
			\subcaption{Segment B}
			\label{sub:GeoTS_B}
		\end{subfigure}
...
\begin{landscape}
	\begin{figure}
		\begin{subfigure}{0.9\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{"Figures/Results_USR/Stochastic/G TS C"}
			\subcaption{Segment C}
			\label{sub:GeoTS_C}	
		\end{subfigure}%
		\begin{subfigure}{0.9\textwidth}
			\centering			
			\includegraphics[width=0.9\textwidth]{"Figures/Results_USR/Stochastic/G TS D"}
			\subcaption{Segment D}
			\label{sub:GeoTS_D}
		\end{subfigure}
...
\begin{landscape}
	\begin{figure}
		\begin{subfigure}{0.9\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{"Figures/Results_USR/Stochastic/G TS E"}
			\subcaption{Segment E}
			\label{sub:GeoTS_E}	
		\end{subfigure}
		\caption{Stochastic geometric parameter time-series.}
...
Tables \ref{tab:SegmentSurfaceArea_A} to \ref{tab:SegmentSurfaceArea_E} and Tables \ref{tab:SegmentSurfaceArea_F} and \ref{tab:SegmentSurfaceArea_G} present the river segment average daily surface area deterministic model time-series and stochastic model summary statistic time-series results for the USR and DSR, respectively.  Summary results for river segment average daily flow depth and river segment average daily top width are not included as they are not direct precursors to the final model results.  The surface area is directly used for precipitation and evaporation calculations.

\begin{table}[htbp]
\centering
\caption[USR river segment A surface area deterministic and stochastic model numerical results.]{USR river segment A surface area deterministic and stochastic model numerical results.  Values are in hectares (acres).}
\label{tab:SegmentSurfaceArea_A}
	\input{"Tables/tableAreaA.txt"}
\end{table}

\begin{table}[htbp]
	\centering
	\caption[USR river segment B surface area deterministic and stochastic model numerical results.]{USR river segment B surface area deterministic and stochastic model numerical results.  Values are in hectares (acres).}
	\label{tab:SegmentSurfaceArea_B}
		\input{"Tables/tableAreaB.txt"}
\end{table}

\begin{table}[htbp]
	\centering
	\caption[USR river segment C surface area deterministic and stochastic model numerical results.]{USR river segment C surface area deterministic and stochastic model numerical results.  Values are in hectares (acres).}
	\label{tab:SegmentSurfaceArea_C}
	\input{"Tables/tableAreaC.txt"}
\end{table}

\begin{table}[htbp]
	\centering
	\caption[USR river segment D surface area deterministic and stochastic model numerical results.]{USR river segment D surface area deterministic and stochastic model numerical results.  Values are in hectares (acres).}
	\label{tab:SegmentSurfaceArea_D}
	\input{"Tables/tableAreaD.txt"}
\end{table}

\begin{table}[htbp]
	\centering
	\caption[USR river segment E surface area deterministic and stochastic model numerical results.]{USR river segment E surface area deterministic and stochastic model numerical results.  Values are in hectares (acres).}
	\label{tab:SegmentSurfaceArea_E}
