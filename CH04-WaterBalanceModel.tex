...
\begin{tabular}{r p{5.5in}}
	Where: \\
	\Qnps = & The sum of gains from non-point sources and losses to non-point sinks $ \left( Q_{UNPS} = R + B - T - F + Q_{U,in} - Q_{U,out}\right) $.\\ 
\end{tabular}\\
...
This model is further simplified to Equation XX which combines terms that are calculated using similar methods to facilitate discussion.
\begin{equation}
	\label{eq:water3}
