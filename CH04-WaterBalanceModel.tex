...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q in"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q in"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q out"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q out"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q BIG"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q BIG"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
		\caption{DSR deterministic and stochastic model time-series average daily flow rate.}
	\end{figure}
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q BUF"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q BUF"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
		\caption{DSR deterministic and stochastic model time-series average daily flow rate.}
	\end{figure}
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q FRO"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q FRO"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
		\caption{DSR deterministic and stochastic model time-series average daily flow rate.}
	\end{figure}
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q WIL"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q WIL"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
		\caption{DSR deterministic and stochastic model time-series average daily flow rate.}
	\end{figure}
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_USR/Deterministic/Balance Water - flow"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_USR/Stochastic/Balance Water - flow"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Balance Water - flow"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Balance Water - flow"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
...
%		\label{sub:USRWaterS}
%	\end{subfigure}
%	\caption[Time series of the USR Arkansas River unaccounted for water flow.]{Time series of the USR Arkansas River unaccounted for water flow.  Positive values indicate a gain to the river reach.}
%	\label{fig:USRWater}
%\end{figure}
%
%\begin{figure}[htbp]
...
%		\label{sub:DSRWaterS}
%	\end{subfigure}
%	\caption[Time series of the DSR Arkansas River unaccounted for water flow.]{Time series of the DSR Arkansas River unaccounted for water flow.  Positive values indicate a gain to the river reach.}
%	\label{fig:DSRWater}
%\end{figure}
%
%As anticipated with the study reach intermediate results, the model results indicate that there is seasonable variability with the transport of selenium.  The figures show that the USR and DSR receive a significant quantity of water from unaccounted for sources.  There is a very short period during midyear where the unaccounted for flows are a sink for water being lost from the Arkansas River
%
...
%		\label{sub:USRMComb}
%	\end{subfigure}
%	\caption[Time series of the major USR Arkansas River contributions to the mass balance model.]{Time series of the major USR Arkansas River contributions to the mass balance model.}
