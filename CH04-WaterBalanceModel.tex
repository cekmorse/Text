...
\begin{table}[htbp]
	...
	\begin{subtable}{\textwidth}
		\centering
		\subcaption*{DSR river segment F}
%		\input{"Tables/tableVolumeF.txt"}
	\end{subtable}\\
	\tablevspace	
	\begin{subtable}{\textwidth}
		\centering
		\subcaption*{DSR river segment G}
%		\input{"Tables/tableVolumeG.txt"}
	\end{subtable}\\
\end{table}	
...
\begin{table}[htbp]
	...
	\begin{subtable}{\textwidth}
		\centering
		\subcaption*{USR river reach average daily water storage change.}
	...
	\begin{subtable}{\textwidth}
		\centering
		%		\includegraphics[width=0.9\linewidth]{"Figures/Results_DSR/Stochastic/Balance Water - storage"}
		\subcaption*{DSR river reach average daily water storage change.}
	\end{subtable}\\
\end{table}
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
%			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q CAN"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
%			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q CAN"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
...
\begin{landscape}
	\begin{figure}
		...
		\begin{subfigure}{0.7\textwidth}
			\centering
%			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Deterministic/Q WTP"}
			\subcaption*{Deterministic}		
		\end{subfigure}%
		\begin{subfigure}{0.7\textwidth}
			\centering
%			\includegraphics[width=\textwidth]{"Figures/Results_DSR/Stochastic/Q WTP"}
			\subcaption*{Stochastic}
		\end{subfigure}\\
